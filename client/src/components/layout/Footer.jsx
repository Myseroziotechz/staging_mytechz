        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2 sm:space-y-2.5">
              ...
              <li>
                <Link href="/ai-tools/resume-analyzer" className="text-xs sm:text-sm text-gray-400 hover:text-purple-400 hover:translate-x-1 inline-block transition-all duration-200">
                  Resume Analyzer
                </Link>
              </li>
              <li>
