...
export default function JobAssistantPanel({ job }) {
  ...
  return (
    <Link
      ...
      className="group relative inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-linear-to-r from-indigo-600 via-blue-600 to-amber-500 text-white text-sm font-semibold shadow-lg shadow-blue-700/25 hover:shadow-xl hover:-translate-y-0.5 transition active:scale-[0.98] overflow-hidden"
    >
