...
describe('analyzeResumeATS', () => {
  ...
  describe('Bigram / phrase matching', () => {
    ...
    it.todo(
      'does not falsely match bigrams from unrelated words — known limitation: ' +
      'the engine matches via resumeLower.includes(kw), so "machine" and "learning" ' +
      'appearing in separate sentences can still register as the "machine learning" ' +
      'bigram. No assertion here yet; documented in the plan rather than asserted.'
    )
  })
})
