      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        ...
        {filtersOpen && (
          <div className="lg:hidden fixed inset-0 z-50 flex items-end" role="dialog">
            {/* Backdrop click-to-close is a mouse-only convenience; keyboard users already
                have equivalent close paths via the visible "Close"/"Show results" buttons below. */}
...
function FiltersPanel({ filters, setFilter }) {
  return (
    <div className="space-y-5 text-sm">
      <div>
        <div className="block text-xs font-semibold text-slate-700 mb-1.5">Work mode</div>
        <div className="flex flex-wrap gap-1.5">
      ...
      <div>
        <div className="block text-xs font-semibold text-slate-700 mb-1.5">Job type</div>
        <div className="flex flex-wrap gap-1.5">
      ...
      <div>
        <div className="block text-xs font-semibold text-slate-700 mb-1.5">Experience (years)</div>
      ...
      <div>
        <label htmlFor="jobs-filter-min-salary" className="block text-xs font-semibold text-slate-700 mb-1.5">Min salary (₹/yr)</label>
        <input id="jobs-filter-min-salary" type="number" min={0} step={50000}
