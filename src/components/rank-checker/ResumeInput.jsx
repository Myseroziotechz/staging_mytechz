  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="rank-checker-job-desc" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">
            Job Description
          </label>
          <textarea
            id="rank-checker-job-desc"
        ...
        <div>
          <label htmlFor="rank-checker-target-role" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">
            Target Role
          </label>
          <input
            id="rank-checker-target-role"
            type="text"
            value={targetRole}
