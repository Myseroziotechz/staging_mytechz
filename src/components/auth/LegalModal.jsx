...
export default function LegalModal({ type, onClose }) {
  ...
  return (
    // Backdrop click-to-close is a mouse-only convenience; keyboard users already have
    // an equivalent close path via the Escape handler above and the visible Close/"I
    // understand" buttons below, so no separate key handler is added here.
    <div
      ref={backdropRef}
