  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4" role="dialog" aria-modal="true">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
        ...
        <label htmlFor="delete-account-confirm" className="block mt-4 text-xs font-medium text-gray-700">
        ...
        <input
          ...
          // Intentional: this is a user-triggered confirmation dialog (not autofocus on
          // page load), and WAI-ARIA's dialog pattern recommends moving focus into the
          // dialog when it opens. autoFocus here is the accessible choice, not a violation.
          autoFocus
        />
