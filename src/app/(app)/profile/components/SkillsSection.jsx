...
function SkillsEditor({ skills, onChange }) {
  ...
  return (
    <div className="space-y-3">
      {/* Mouse-only convenience: extends the click target to the padding around the tags.
          The actual control is the <input> below, which is already independently
          reachable and operable via Tab/keyboard, so no keyboard handler is needed here. */}
      <div
