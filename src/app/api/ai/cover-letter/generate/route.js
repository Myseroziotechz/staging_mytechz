...
import { generateCoverLetterContent, isGeminiConfigured, MODEL } from '@/lib/ai/gemini'
...
export async function POST(req) {
  ...
  try {
    ...
    console.error('[api/ai/cover-letter/generate] generateCoverLetterContent failed:', err.message)
    try {
      await supabase.from('ai_generation_logs').insert({
        user_id: user.id,
        action_type: 'cover_letter_generate',
